 ...
 */
THREE.glowShader.dilateGeometry	= function(geometry, length){
 ...
 */
THREE.glowShader.createAtmosphereMaterial	= function(){
	var vertexShader	= [
...
THREE.glowShader.GeometricGlowMesh	= function(mesh){
    ...
    let material	= THREE.glowShader.createAtmosphereMaterial()
    material.uniforms.glowColor.value	= new THREE.Color('cyan')
    material.uniforms.coeficient.value	= 1.1
    material.uniforms.power.value		= 1.4
    let insideMesh	= new THREE.Mesh(geometry1, material );
    object3d.add( insideMesh );


    geometry2 = mesh.geometry.clone();
    THREE.glowShader.dilateGeometry(geometry2, 0.1)
    let material2	= THREE.glowShader.createAtmosphereMaterial()
    material2.uniforms.glowColor.value	= new THREE.Color('cyan')
    material2.uniforms.coeficient.value	= 0.5
